...
|Shubham Singh| Frontend Developer/Fullstack Developer | Pune, India | HTML, CSS, Javascript, Angular, ReactJS, TailwindCSS, Bootstrap, Material UI, CSS-in-JS ,D3, Charts,js, NodeJS, MongoDB, Redis, Socket.io, RESTful API's | Remote or On Site | [Email](mailto:shubhsingh01@gmail.com)<br />[Github](https://github.com/shubh0107)<br />[Resume](https://shubh0107.github.io/) |
