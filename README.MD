...
|Prince Kumar Singh | Frontend Engineer | Bengaluru | JavaScript, TypeScript, ReactJS, Python, UX Design | On-site/Remote | [Portfolio](https://prnx.dev/) <br /> [GitHub](http://github.com/drkPrince) <br /> [LinkedIn](http://linkedin.com/in/prnx) <br /> [Twitter](http://twitter.com/drkPrns) <br /> [Email](mailto:thedrkprns@protonmail.com) |
