...
|Fahad Ali |Software Development Engineer |India |Node.js, Express.js, React, Spring Boot, C/C++, Java, Python, JavaScript, HTML, CSS, MySQL, MongoDB, PostgresSQL, Docker, AWS |Remote |[Email](mailto:zxvf@tutanota.com) <br/> [LinkedIn](https://www.linkedin.com/in/imf-ali/) <br/> [Github](https://github.com/imf-ali) <br/> [Portfolio](https://imf-ali.netlify.app/) <br/> [Twitter](https://twitter.com/imf_ali)  |
