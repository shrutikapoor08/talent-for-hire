...
| Vaibhav Bhavsar | Full Stack Web Developer/Software Development | India | Angular, React, Django, Typescript, JavaScript, NodeJS, ExpressJS, Firebase, GitHub, HTML, CSS, Bootstrap, Materialized CSS, Python, C++, AWS, Google Cloud | Remote, Relocation, On-site | [LinkedIn](https://www.linkedin.com/in/vaibhav-bhavsar) <br /> [Email](mailto:vaibhavbhavsar007@gmail.com) <br /> [GitHub](https://github.com/IamVaibhavsar) <br /> [Twitter](http://twitter.com/IamVaibhavsar) |
