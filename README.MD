...
|  Name 	|  Role 	|   Location	|   Skills	|   Remote	|   Contact	|
| ------------- |-------------| -----| ------------- |-------------| -----|
 |Manushivam  | Front-end Engineer | Am based from Noida, open to work anywhere | Reactjs+Hooks, Redux, Redux-Saga, Angular, Nodejs, React Native, Nodejs, Sass, Html/Css, Cypress | Yes | 9988479897, https://www.linkedin.com/in/manushivam/ |
